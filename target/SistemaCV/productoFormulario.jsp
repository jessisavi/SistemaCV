            ...
            <div class="col-lg-10">
                <div class="card card-custom mt-4">
                    <div class="card-header card-header-custom">
                        ...
                        <a href="${pageContext.request.contextPath}/inventario" class="btn btn-outline-custom btn-sm">
                            <i class="fas fa-arrow-left me-1"></i> Volver
                        </a>
                    </div>
                    <div class="card-body">
                        <form action="${pageContext.request.contextPath}/inventario" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="stockMinimo" name="stockMinimo" 
                                               value="<%= isEdit ? producto.getStockMinimo() : "10" %>" required>
                                    </div>
                                    <div class="mb-3">
